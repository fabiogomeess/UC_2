...
print(f"\nO valor do quartil 1 é {q1_idade}.")
...
print(f"\nO valor do quartil 1 é {q1_salario}.")
...
print(f"\nO total de funcionários da empresa é de {qtd_funcionarios} pessoas.")
print(f"\nO valor do quartil 1 é {q1_tempo}.")
