# Crimes Violentos Letais Intencionais – CVLI - GERAL
...
if len(df_cvli_outliers_superiores) != 0 or len(df_cvli_outliers_inferiores) != 0:
    ...
    # Posição 03: Crimes Violentos Letais Intencionais com Outliers Superiores
    df_cvli_outliers_superiores_order = df_cvli_outliers_superiores.sort_values(by='cvli',ascending=True)
    plt.subplot(2,2,3)
    plt.title('Ranking sobre Crimes Violentos Letais Intencionais com Outliers Superiores')
